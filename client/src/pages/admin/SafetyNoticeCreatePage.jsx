...
export default function SafetyNoticeCreatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (attachmentType === 'upload' && imageFile) {
        formData.append('image', imageFile);
      } else if (attachmentType === 'url' && imageUrlLink.trim()) {
        formData.append('imageUrlLink', imageUrlLink.trim());
      }

      await safetyNoticeService.create(formData);
      navigate('/admin/safety-notices');
    } catch (err) {
      setError(err.response?.data?.error || 'Failed to create safety notice.');
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="page">
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h1>New Safety Notice</h1>
            <p style={{ marginTop: 4, fontSize: '0.85rem' }}>Create a new safety notice, directive or emergency guideline</p>
          </div>
        </div>
      </div>
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div className="form-group">
            ...
            <input 
              ...
              placeholder="e.g. SN-2024-002 Point 301 Replacement at ADM Station" 
              value={form.title}
          ...
          <div className="form-group">
            ...
            <textarea 
              className="form-control" 
              rows={12}
              placeholder="Provide detailed instructions and safety critical details here..."
              value={form.content}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', padding: '4px 0' }}>
              ...
              />
              <div>
                <span className="form-label" style={{ margin: 0, display: 'block' }}>Publish Immediately</span>
